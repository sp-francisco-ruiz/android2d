...
namespace engine
{
    namespace physics
    {
        ...
        protected:
            ...
            static bool
            CheckPointRect(float px, float py, float rectMinX, float rectMinY, float rectMaxX,
                           float rectMaxY);

            static float
            ClosestDistanceInSegmentToPointSq(float fromX, float fromY, float toX, float toY, float px,
                                              float py);
